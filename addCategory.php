...
if(isset($_POST['enviar']) && $_POST['enviar'] == 'Save'){
    ...
    if(!empty($_POST['catCategory']) && !empty($_POST['catDescription']) && !empty($_POST['catType'])){
       ...
       // insert...
		$sqlInsertCat=$dbConnX->insertCategory($catCategory,$catDescription,$catType);
		echo "<div STYLE='position:absolute; TOP:550px; LEFT:400px'>The Category has been registered.... (".$catCategory.")</div>";
