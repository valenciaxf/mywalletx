...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  if (isset($_POST['enviar']) && $_POST['enviar'] == 'Registrar') {
    ...
    if (
      !empty($_POST['username']) && !empty($_POST['pwd1']) && !empty($_POST['pwd2'])
  ...
  <form id="sform" name="categoria" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <p>
      Login<br>
      <input id="field_username" type="text" name="username" minlength="3" maxlength="30"
        title="Introducir el username que se usará para el login. Al menos 3 carácteres, máximo 30. (Letras, números, guiones bajos son válidos)" />
      <br>
    </p>
    <p>
      Password<br>
      <input id="field_pwd1"
        title="El password debe contener al menos 6 carácteres, incluyendo MAYÚSCULAS/minúsculas y números."
        type="password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" name="pwd1" />
      <br>
    </p>
    <p>
      Confirmar Password<br>
      <input id="field_pwd2" title="Por favor introduce el mismo password que arriba." type="password" required
        pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" name="pwd2" />
      <br>
    </p>
    <p>
      Número de Contacto<br>
      <input type="text" name="contactNumberFrm" minlength="3" maxlength="30"
        title="Al menos tres carácteres, máximo 30" />
      <br>
    </p>
    <p>
      Nombre(s)<br>
    ...
    <p>
      Mail<br>
      <input type="text" name="mlFrm" type="email" minlength="3" maxlength="60" required
        placeholder="Introduce un mail válido. Máximo 60 carácteres" />
      <br>
    </p>
    <p>
      Facebook<br>
