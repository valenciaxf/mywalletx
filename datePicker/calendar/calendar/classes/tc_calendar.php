...
class tc_calendar{
	...
	private function processScript($buffer = false){
		$str = "";
	...
	private function writeCalendarContainer(){
		$params = array();
	...
	private function eHidden($suffix, $value) {
	...
	private function writeDateContainer(){
	...
	*/
	...
	private function checkDefaultDateValid($reset = true){
...
*/
	...
	public static function check_json_decode($str){
