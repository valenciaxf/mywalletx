...
class MyApp extends StatelessWidget {
  ...
  void SaveData(String name, String pass) async{
    var url = 'http://localhost/flutter_app/flutter_register.php';
  ...
  void updateData(String id,String name,String pass)async{
    var url = 'http://localhost/flutter_app/flutter_update.php';
    var data = {"_id":id,"nm":name,"pss":pass};
    var res = await http.post(url,body: data);
  }

  void deleteData(String _id)async{
    var url = 'http://localhost/flutter_app/flutter_delete.php';
    var data = {"id":_id};
    var res = await http.post(url,body: data);
  }

  Future getData() async{
    var url = "http://localhost/flutter_app/flutter_getData.php";
